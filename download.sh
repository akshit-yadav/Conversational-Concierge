...
#wget https://object.pouta.csc.fi/OPUS-OpenSubtitles/v1/mono/en.txt.gz -O temp.zip
wget https://object.pouta.csc.fi/OPUS-OpenSubtitles/v2018/moses/en-es.txt.zip -O temp.zip;
